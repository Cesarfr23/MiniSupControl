...
namespace MiniSupControl.Consultas
{
    public partial class ConsultarClientes : Form
    {
        ...
        {
            ClienteDataGridView.DataSource =ClienteBll.GetLista();
        }
        ...
        private void ImprimirButton_Click(object sender, EventArgs e)
        {
            ...
            viewer.reportViewer1.LocalReport.ReportPath = @"Reportes\Listado_Clientes.rdlc";

            viewer.reportViewer1.LocalReport.DataSources.Clear();

            viewer.reportViewer1.LocalReport.DataSources.Add(
                new ReportDataSource("Cliente",
                ClienteBll.GetLista()));
